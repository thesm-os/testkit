...
func WithReaderFaults[T any, K comparable, V any](
	b bindings.ReaderBindings[T, K, V],
	clock clock.Clock,
	faults ...testkit.Fault[ReaderCall[T, K, V]],
) bindings.ReaderBindings[T, K, V] {
	if len(faults) == 0 {
		return b
	}
	return bindings.ReaderBindings[T, K, V]{
		Factory: b.Factory,
...
func WithWriterFaults[T, V any](
	b bindings.WriterBindings[T, V],
	clock clock.Clock,
	faults ...testkit.Fault[WriterCall[T, V]],
) bindings.WriterBindings[T, V] {
	if len(faults) == 0 {
		return b
	}
	return bindings.WriterBindings[T, V]{
		Factory: b.Factory,
...
func WithDeleterFaults[T any, K comparable](
	b bindings.DeleterBindings[T, K],
	clock clock.Clock,
	faults ...testkit.Fault[DeleterCall[T, K]],
) bindings.DeleterBindings[T, K] {
	if len(faults) == 0 {
		return b
	}
	return bindings.DeleterBindings[T, K]{
		Factory: b.Factory,
...
func WithAggregatorFaults[T, R any](
	b bindings.AggregatorBindings[T, R],
	clock clock.Clock,
	faults ...testkit.Fault[AggregatorCall[T, R]],
) bindings.AggregatorBindings[T, R] {
	if len(faults) == 0 {
		return b
	}
	return bindings.AggregatorBindings[T, R]{
		Factory: b.Factory,
...
func WithLifecycleFaults[T any](
	b bindings.LifecycleBindings[T],
	clock clock.Clock,
	faults ...testkit.Fault[LifecycleCall[T]],
) bindings.LifecycleBindings[T] {
	if len(faults) == 0 {
		return b
	}
	return bindings.LifecycleBindings[T]{
		Factory: b.Factory,
