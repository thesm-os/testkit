...
func segConsts() map[string]string {
	return map[string]string{
		...
		SegSideEffect:   "SegSideEffect",
		SegPartition:    "SegPartition",
		SegNilArgument:  "SegNilArgument",
		SegOrderAfter:   "SegOrderAfter",
		SegValidates:    "SegValidates",
		SegAnswer:       "SegAnswer",
		SegConflict:     "SegConflict",
		SegMatch:        "SegMatch",
		SegBound:        "SegBound",
		SegHooks:        "SegHooks",
		SegMiss:         "SegMiss",
...
func classConsts() map[Class]string {
	return map[Class]string{
		...
		ClassSideEffect:   "ClassSideEffect",
		ClassPartition:    "ClassPartition",
		ClassAccumulates:  "ClassAccumulates",
		ClassNilArgument:  "ClassNilArgument",
		ClassOrderAfter:   "ClassOrderAfter",
		ClassValidates:    "ClassValidates",
