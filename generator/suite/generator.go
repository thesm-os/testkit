...
// Package suite is a placeholder for the suite generator port from
// the legacy gen/suite package. The CLI dispatches to [Generator]
...
// in gen/suite; the rebuild moves it under this package.
func (*Generator) Generate(
	_ *generator.Package, _ []string, _ generator.Config, _ generator.Options,
) (*generator.Result, error) {
	return nil, errors.New("suite: generator port pending")
}
