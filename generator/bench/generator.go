...
// Package bench is a placeholder for the bench generator port from
// the legacy gen/bench package. The CLI dispatches to [Generator]
...
// in gen/bench; the rebuild moves it under this package.
func (*Generator) Generate(
	_ *generator.Package, _ []string, _ generator.Config, _ generator.Options,
) (*generator.Result, error) {
	return nil, errors.New("bench: generator port pending")
}
