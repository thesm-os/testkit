...
// proving end-to-end action dispatch for Reader, Writer, Deleter,
// Aggregator, Lifecycle, Pure, Predicate, and StreamReader.
package allshapes
...
//go:generate testkit model -o servicetest/service_model.gen.go Service
