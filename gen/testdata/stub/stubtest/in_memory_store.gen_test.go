...
func TestStoreStub(t *testing.T) {
	...
	t.Run("WithStoreDelete constructor option", func(t *testing.T) {
		t.Parallel()
		called := false
		s := stubtest.NewStoreStub(t, stubtest.WithStoreDelete(func(context.Context, string) error {
			called = true
			return nil
		}))
		_ = s.Delete(t.Context(), "")
	...
	t.Run("WithStoreGet constructor option", func(t *testing.T) {
		t.Parallel()
		called := false
		s := stubtest.NewStoreStub(t, stubtest.WithStoreGet(func(context.Context, string) (stub.Item, error) {
			called = true
	...
	t.Run("WithStoreList constructor option", func(t *testing.T) {
		t.Parallel()
		called := false
		s := stubtest.NewStoreStub(t, stubtest.WithStoreList(func(context.Context) []stub.Item {
			called = true
			return nil
		}))
		_ = s.List(t.Context())
