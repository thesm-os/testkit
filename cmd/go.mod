...
require (
	...
	go.thesmos.sh/eidos/cli v1.6.1
...
require (
	...
	go.thesmos.sh/eidos/backend/golang v1.6.0 // indirect
	go.thesmos.sh/eidos/frontend/golang v1.6.2 // indirect
	go.thesmos.sh/eidos/plugins v1.7.1 // indirect
