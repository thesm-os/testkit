...
// Package refsaga provides the [CompensatingSaga] reference for the
...
// Step is one step of the saga. Run is the forward action;
...
func NewCompensatingSaga[T any](steps []Step[T]) *CompensatingSaga[T] {
