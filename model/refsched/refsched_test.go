...
import (
	...
	"go.thesmos.sh/testkit/model/refsched"
)
...
func TestPureScheduler(t *testing.T) {
	...
	t.Run("linear chain schedules in dependency order", func(t *testing.T) {
		t.Parallel()
		s := refsched.NewPureScheduler[string, string](stringLess, identity)
	...
	t.Run("cycle detection", func(t *testing.T) {
		...
		testkit.True(t, errors.Is(err, refsched.ErrCycle), "cycle detected")
	})
