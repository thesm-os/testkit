...
func TestCountedFault(t *testing.T) {
	...
	t.Run("fires on every Nth call", func(t *testing.T) {
		t.Parallel()
		f := testkit.NewCountedFault[string](errors.New("boom"), 3)
	...
	t.Run("returns configured error", func(t *testing.T) {
		...
		f := testkit.NewCountedFault[string](err, 1)
	...
	t.Run("disabled when n is zero", func(t *testing.T) {
		t.Parallel()
		f := testkit.NewCountedFault[string](errors.New("boom"), 0)
		for range 10 {
	...
	t.Run("disabled when n is negative", func(t *testing.T) {
		t.Parallel()
		f := testkit.NewCountedFault[string](errors.New("boom"), -1)
		fired, _ := f.ShouldFire("", nil)
	...
	t.Run("ignores call value and clock", func(t *testing.T) {
		t.Parallel()
		f := testkit.NewCountedFault[int](errors.New("boom"), 1)
...
func TestRetryFault(t *testing.T) {
	...
	t.Run("fails first N-1 calls, succeeds on Nth", func(t *testing.T) {
		t.Parallel()
		f := testkit.NewRetryFault[string](errors.New("unavailable"), 3)
	...
	t.Run("n=1 succeeds immediately", func(t *testing.T) {
		t.Parallel()
		f := testkit.NewRetryFault[string](errors.New("boom"), 1)
		fired, _ := f.ShouldFire("", nil)
	...
	t.Run("Reset rewinds counter", func(t *testing.T) {
		t.Parallel()
		f := testkit.NewRetryFault[string](errors.New("boom"), 2)
...
func TestPredicateFault(t *testing.T) {
	...
	t.Run("fires when predicate matches", func(t *testing.T) {
		t.Parallel()
		f := testkit.NewPredicateFault[call](
			errors.New("targeted"),
...
func TestAndFault(t *testing.T) {
	...
	t.Run("fires when all inner faults fire", func(t *testing.T) {
		t.Parallel()
		pred := testkit.NewPredicateFault[call](errors.New("pred"), func(c call) bool { return c.RunID == "run-1" })
		counted := testkit.NewCountedFault[call](errors.New("counted"), 1)
		composed := testkit.And[call](pred, counted)
	...
	t.Run("Reset resets all inner faults", func(t *testing.T) {
		t.Parallel()
		counted := testkit.NewCountedFault[call](errors.New("boom"), 2)
		composed := testkit.And[call](counted)
...
func TestOrFault(t *testing.T) {
	...
	t.Run("fires when any inner fault fires", func(t *testing.T) {
		...
		pred1 := testkit.NewPredicateFault[call](errors.New("pred1"), func(c call) bool { return c.RunID == "run-1" })
		pred2 := testkit.NewPredicateFault[call](errPred2, func(c call) bool { return c.RunID == "run-2" })
		composed := testkit.Or[call](pred1, pred2)
	...
	t.Run("Reset resets all inner faults", func(t *testing.T) {
		t.Parallel()
		counted := testkit.NewCountedFault[call](errors.New("boom"), 2)
		composed := testkit.Or[call](counted)
		_, _ = composed.ShouldFire(call{}, nil) // call 1
		composed.Reset()
