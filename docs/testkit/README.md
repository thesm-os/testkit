...
| [`model`](generators/model.md) | Tier 2-3: rapid property-based state-machine with differential testing, shape-specific laws, concurrent stress, trace combinators (planned) |
