...
func (s *MethodStub[C]) Faults(err error, failEveryN int) *MethodStub[C] {
	s.fault = NewCountedFault[C](err, failEveryN)
	return s
}
...
func (s *MethodStub[C]) SetFault(f Fault[C]) *MethodStub[C] {
	s.fault = f
	return s
}
...
func (s *MethodStub[C]) FaultsWhen(pred func(C) bool, err error, n int) *MethodStub[C] {
	s.fault = And[C](
		NewPredicateFault[C](err, pred),
		NewCountedFault[C](err, n),
	)
	return s
}
...
func (s *MethodStub[C]) FaultsWithProbability(p float64, err error) *MethodStub[C] {
	...
	s.fault = NewProbabilityFault[C](err, p, src)
	return s
}
...
func (s *MethodStub[C]) FaultsUntil(deadline time.Time, err error) *MethodStub[C] {
	s.fault = NewWindowedFault[C](err, deadline)
	return s
}
...
func (s *MethodStub[C]) FaultsFor(d time.Duration, err error) *MethodStub[C] {
	...
	s.fault = NewWindowedFault[C](err, now.Add(d))
	return s
}
...
func (s *MethodStub[C]) WithClock(clk Clock) *MethodStub[C] {
	s.clock = clk
...
func (s *MethodStub[C]) WithRandSource(src RandSource) *MethodStub[C] {
	s.rand = src
	return s
}
...
func (s *MethodStub[C]) Clock() Clock {
	return s.clock
}
