...
func DefaultMixedFixture() MixedFixture {
	return MixedFixture{
		V:        monotonicreads.Value{Key: "test-key", Body: "test-body", Rev: 42},
		VOther:   monotonicreads.Value{Key: "other-key", Body: "other-body", Rev: 7},
		Key:      "test-key",
		KeyOther: "other-key",
	}
}
...
// testkit:provenance 912971d8ea530ba781a260dd682ac06a76b89793009b7774af14e45c95aff8eb
