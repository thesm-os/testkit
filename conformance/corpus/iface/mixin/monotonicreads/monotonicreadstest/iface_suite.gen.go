...
func DefaultMixedFixture() MixedFixture {
	return MixedFixture{
		V:        monotonicreads.Value{Key: "test-key", Body: "test-body", Rev: 1},
		VOther:   monotonicreads.Value{Key: "other-key", Body: "other-body", Rev: 2},
		Key:      "test-key",
		KeyOther: "other-key",
	}
}
...
// testkit:provenance d8485297141193e0520f46694a1efd05fd610ff753eb69a8aadd8e7f7fa4c3ae
