...
func DefaultMixedFixture() MixedFixture {
	return MixedFixture{
		V:        readyourwrites.Value{Key: "test-key", Body: "test-body"},
		VOther:   readyourwrites.Value{Key: "other-key", Body: "other-body"},
		Key:      "test-key",
		KeyOther: "other-key",
	}
}
...
// testkit:provenance 195d32760ec0c41e654360f1edabc4ba03cbde8682accd52cdabe36249713a54
