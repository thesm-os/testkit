...
func DefaultMixedFixture() MixedFixture {
	return MixedFixture{
		V:        readyourwrites.Value{Key: "test-key", Body: "test-body", Rev: 42},
		VOther:   readyourwrites.Value{Key: "other-key", Body: "other-body", Rev: 7},
		Key:      "test-key",
		KeyOther: "other-key",
	}
}
...
// testkit:provenance 9d80ddfd173bb4aaa09738599c4b1bdfcfa85398148067278c979f02aea33d74
