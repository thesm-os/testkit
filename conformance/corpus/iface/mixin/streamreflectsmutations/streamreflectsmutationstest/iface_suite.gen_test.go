...
func TestAssertMixedStreamSmokeCanFail(t *testing.T) {
	...
	testkit.Assert(t, got).Contains("Stream panicked on a derived value",
...
func TestAssertMixedStreamToleratesNilContextCanFail(t *testing.T) {
	...
	testkit.Assert(t, got).Contains("Stream panicked on a nil context",
		"and rejects it for the reason the check is about")
}
...
func TestAssertMixedRemoveSmokeCanFail(t *testing.T) {
	...
	testkit.Assert(t, got).Contains("Remove panicked on a derived value",
		"and rejects it for the reason the check is about")
}
...
func TestAssertMixedRemoveCancelsCanFail(t *testing.T) {
	...
	testkit.Assert(t, got).Contains("Remove must report a cancelled context as context.Canceled",
		"and rejects it for the reason the check is about")
}
...
func TestAssertMixedRemoveHonoursDeadlineCanFail(t *testing.T) {
	...
	testkit.Assert(t, got).Contains("Remove must report an expired deadline as context.DeadlineExceeded",
		"and rejects it for the reason the check is about")
}
...
func TestAssertMixedRemoveToleratesNilContextCanFail(t *testing.T) {
	...
	testkit.Assert(t, got).Contains("Remove panicked on a nil context",
		"and rejects it for the reason the check is about")
}

// testkit: end of generated content.
// testkit:provenance ed4f497cd0e86a375c29b56b66cb92f09798bab6c4342535b22f4ce7a8816811
