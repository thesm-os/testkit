...
type MixedStoreStub struct {
	*stub.MethodStub[MixedStoreCall]
	...
	fn       func(context.Context, causal.Value) error
...
func (s *MixedStoreStub) Func(fn func(context.Context, causal.Value) error) *MixedStoreStub {
	s.fn = fn
	return s
}
...
func WithMixedStore(fn func(context.Context, causal.Value) error) MixedStubOption {
...
// restated per method.
func (s *MixedStub) Store(ctx context.Context, v causal.Value) error {
...
// testkit:provenance a8309a05e54a812b036d86f38f4aca9a1541b92813de3a062548dd8a7f7b004b
