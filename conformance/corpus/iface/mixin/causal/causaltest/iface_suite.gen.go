...
func DefaultMixedFixture() MixedFixture {
	return MixedFixture{
		V:        causal.Value{Key: "test-key", Body: "test-body"},
		VOther:   causal.Value{Key: "other-key", Body: "other-body"},
		Key:      "test-key",
		KeyOther: "other-key",
	}
}
...
// testkit:provenance ac3b64d14d080a90f02dd04e37604dd13492b88fa5527927c5d026e8aee4382a
