...
func DefaultMixedFixture() MixedFixture {
	return MixedFixture{
		V:        causal.Value{Key: "test-key", Body: "test-body", Rev: 42},
		VOther:   causal.Value{Key: "other-key", Body: "other-body", Rev: 7},
		Key:      "test-key",
		KeyOther: "other-key",
	}
}
...
// testkit:provenance 9d1035552096217b1e3917d4c6bc94cd08939b6a81c7eb55096fd80d7b30f35b
