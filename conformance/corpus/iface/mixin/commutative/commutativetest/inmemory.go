...
// Package commutativetest holds the generated harness and double for
// [go.thesmos.sh/testkit/conformance/corpus/iface/mixin/commutative], and the
...
var _ commutative.Mixed = (*InMemory)(nil)
...
func (s *InMemory) Apply(ctx context.Context, d commutative.Delta) error {
...
func contextErr(ctx context.Context) error {
	if ctx == nil {
		return errors.New("commutativetest: nil context")
	}
	return ctx.Err()
}
