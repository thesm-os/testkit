...
// Package associativetest holds the generated harness and double for
// [go.thesmos.sh/testkit/conformance/corpus/iface/mixin/associative], and the
...
var _ associative.Mixed = (*InMemory)(nil)
...
func (s *InMemory) Apply(ctx context.Context, d associative.Delta) error {
...
func contextErr(ctx context.Context) error {
	if ctx == nil {
		return errors.New("associativetest: nil context")
	}
	return ctx.Err()
}
