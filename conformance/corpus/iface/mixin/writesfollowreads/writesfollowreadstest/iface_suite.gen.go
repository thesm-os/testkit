...
func DefaultMixedFixture() MixedFixture {
	return MixedFixture{
		V:        writesfollowreads.Value{Key: "test-key", Body: "test-body", Rev: 42},
		VOther:   writesfollowreads.Value{Key: "other-key", Body: "other-body", Rev: 7},
		Key:      "test-key",
		KeyOther: "other-key",
	}
}
...
// testkit:provenance 64e2c0b978d4a706fbc24b475c2f041f17873a11b02bb01085c71bd010e37070
