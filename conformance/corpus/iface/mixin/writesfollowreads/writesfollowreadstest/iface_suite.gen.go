...
func DefaultMixedFixture() MixedFixture {
	return MixedFixture{
		V:        writesfollowreads.Value{Key: "test-key", Body: "test-body"},
		VOther:   writesfollowreads.Value{Key: "other-key", Body: "other-body"},
		Key:      "test-key",
		KeyOther: "other-key",
	}
}
...
// testkit:provenance e22bbdfff0c8aa0a7d13183a13c9192dde85f7fa5dad90c6c9a1d4cd3522ee1f
