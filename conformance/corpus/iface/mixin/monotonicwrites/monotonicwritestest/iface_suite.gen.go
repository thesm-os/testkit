...
func DefaultMixedFixture() MixedFixture {
	return MixedFixture{
		V:        monotonicwrites.Value{Key: "test-key", Body: "test-body"},
		VOther:   monotonicwrites.Value{Key: "other-key", Body: "other-body"},
		Key:      "test-key",
		KeyOther: "other-key",
	}
}
...
// testkit:provenance 8b69b17ed6c6756c6f177e19904d84dbf453c1b3d98044c40ec10d2925351a26
