...
func DefaultMixedFixture() MixedFixture {
	return MixedFixture{
		V:        monotonicwrites.Value{Key: "test-key", Body: "test-body", Rev: 42},
		VOther:   monotonicwrites.Value{Key: "other-key", Body: "other-body", Rev: 7},
		Key:      "test-key",
		KeyOther: "other-key",
	}
}
...
// testkit:provenance 610401338399c0fee2f2a4172b13ff0330abc8df77368da80b59eea7aaecbe8b
