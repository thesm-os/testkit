...
func TestAssertContractStateZeroOnErrorCanFail(t *testing.T) {
	...
	testkit.Assert(t, got).Contains("State must return the zero value alongside an error",
		"and rejects it for the reason the check is about")
}

// testkit: end of generated content.
// testkit:provenance faa4125bcab011915c7ada432287cedc586abdeff1fe7dedcc8028087fe062bd
