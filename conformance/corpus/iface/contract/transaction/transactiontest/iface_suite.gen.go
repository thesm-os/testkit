...
type ContractRunCheck func(tb testing.TB, subject transaction.Contract, key string)
...
func AssertContractRunSmoke(tb testing.TB, subject transaction.Contract, key string) {
	tb.Helper()
	defer func() {
		if r := recover(); r != nil {
...
// check written twice.
func AssertContractRunCancels(tb testing.TB, subject transaction.Contract, key string) {
	tb.Helper()
...
func AssertContractRunHonoursDeadline(tb testing.TB, subject transaction.Contract, key string) {
	tb.Helper()
...
// request.
func AssertContractRunToleratesNilContext(tb testing.TB, subject transaction.Contract, key string) {
	tb.Helper()
	defer func() {
		if r := recover(); r != nil {
...
// testkit:provenance e5e03e233eabcdf1ad91c940804a21c1db8ddeacd6716b6cd525df42aa426c5b
