...
func TestAssertContractRunZeroOnErrorCanFail(t *testing.T) {
	...
	testkit.Assert(t, got).Contains("Run must return the zero value alongside an error",
		"and rejects it for the reason the check is about")
}

// testkit: end of generated content.
// testkit:provenance d90a354fb698b46be304c270960f4bc1c8fe01b3ce1ea7a0e24f147fc824cdb3
