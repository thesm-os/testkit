	...
	for _, s := range cfg.subjects {
		...
		if !cfg.withoutDouble {
			runContractChecks(t, cfg, s.name+" through the double", s.factory,
				func(tb testing.TB, subject appender.Contract) appender.Contract {
...
func AssertContractRunZeroOnError(tb testing.TB, subject appender.Contract, v appender.Value) {
	...
	if r1 == nil {
		tb.Skipf("Run accepted the alternate input; nothing this run " +
...
var contractPaths = map[string]struct{}{
	...
	"Run/an error carries the zero value": {},
}
...
// testkit:provenance 765bd231a58f0f8b732d83dfeb90c835c4421378619c07cecc911ba8720b9161
