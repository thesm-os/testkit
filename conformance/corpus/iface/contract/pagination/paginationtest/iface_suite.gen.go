...
type ContractGetCheck func(tb testing.TB, subject pagination.Contract, key string)
...
func AssertContractGetSmoke(tb testing.TB, subject pagination.Contract, key string) {
	tb.Helper()
	defer func() {
		if r := recover(); r != nil {
...
// check written twice.
func AssertContractGetCancels(tb testing.TB, subject pagination.Contract, key string) {
	tb.Helper()
...
func AssertContractGetHonoursDeadline(tb testing.TB, subject pagination.Contract, key string) {
	tb.Helper()
...
// request.
func AssertContractGetToleratesNilContext(tb testing.TB, subject pagination.Contract, key string) {
	tb.Helper()
	defer func() {
		if r := recover(); r != nil {
...
func AssertContractGetZeroOnError(tb testing.TB, subject pagination.Contract, key string) {
	tb.Helper()
	ctx := tb.Context()
...
// testkit:provenance 0bd82bb49a7bb6f25bf7ced6142182abeb6fc45b12d08a2b960b9f79d7952f1c
