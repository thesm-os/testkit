...
// Plugins:   golang 1.0.0, builder 1.1.0, backend.golang 1.0.0
...
func TestNewSettingsFrom(t *testing.T) {
	...
	t.Run("carries the value through untouched", func(t *testing.T) {
		...
		seed := crosspkgtest.NewSettings().WithRetries(42).WithRegion("test-region").Build()
...
// testkit:provenance d239eccb5b952e7cf9c0f887ea3fcae8cba10ccd9f0fccb35c7599ca526b830d
